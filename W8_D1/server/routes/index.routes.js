...
router.post("/:projId/update", isValidObjectId, (req, res, next) => {
...
router.post("/:projId/delete", isValidObjectId, (req, res, next) => {
  let projectId = req.params.projId;
...
router.post("/:projId/addTask", isValidObjectId, (req, res, next) => {
  let projectId = req.params.projId;
  let {task} = req.body;
...
router.get("/:projId", isValidObjectId, (req, res, next) => {
  // let projectId = req.params.projId;
