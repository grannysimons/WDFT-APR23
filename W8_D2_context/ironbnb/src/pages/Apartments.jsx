...
export default function Apartments() {
    ...
    const { apartments, getApartments } = useContext(apartmentContext)
    ...
    return (
        <div>
            ...
            <h1>Apartments</h1>
            {filteredApartments.map((apartment, k) => {
                return (<div key={apartment._id?apartment._id:k} className="card">
